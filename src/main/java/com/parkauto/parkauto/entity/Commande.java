...
public class Commande {
	...
	public Commande(int qte, String dateCmd, String description, double prix, 
	...
	public Commande(Long id, int qte, String dateCmd, String description, double prix, double prixTotal,
			Client client) {
		super();
		this.id = id;
		this.qte = qte;
	...
	public Commande(int qte, String dateCmd, String description, double prix, double prixTotal, Client client,
